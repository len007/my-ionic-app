...
export class ScrollDirective {
  ...
  protected windowScrollEvent($event: Event) {
    ...
    const isOverEvent = scrollTop  > this.bottomOffset;
    const emitValue: ScrollEvent = { isReachingBottom, isReachingTop, originalEvent: $event, isWindowEvent: true, isOverEvent: isOverEvent };
  ...
  protected elementScrollEvent($event: Event) {
    ...
    const isOverEvent = scrollTop  > this.bottomOffset;
    const emitValue: ScrollEvent = { isReachingBottom, isReachingTop, originalEvent: $event, isWindowEvent: false, isOverEvent: isOverEvent};
    this.onScroll.emit(emitValue);
  }
}